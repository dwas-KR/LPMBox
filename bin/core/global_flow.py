...
from .constants import FLASH_XML_DLAGENT, FLASH_XML_ROOT, IMAGE_DIR, READBACK_DIR, TOOLS_DIR
...
from .utils import clear_console, log, wait_for_device, _write_log_line
...
def run_global_firmware_upgrade_flow() -> None:
    ...
    while True:
        ...
        log('flow.rebooting')
        adb_reboot()
        if wait_for_preloader(timeout=7):
            break
